            ...
            <div class="col-md-7">
                ...
                <div class="billing-details">
                    ...
                    <div class="form-group">
                        ...
                        <input class="input" type="text" value="{{ auth()->user()->last_name }}" name="last_name"
                    ...
                    <div class="form-group">
                        <label>Mobile</label>
                        <input class="input" type="tel" value="{{ auth()->user()->mobile }}" name="phone_number"
            ...
            <div class="col-md-5 order-details">
                        ...
                        <div class="order-col">
                            <div><?php $sum = 0 ?>
                                @foreach($item['color_items'] as $key=> $c)
                                        <?php $sum += $c['quantity'] ?>
                                @endforeach {{ $sum }}x {{ \App\Models\Product::find($item['id'])->title}}</div>
                ...
                <div class="payment-method">
                    ...
                    <div class="wrapper">
                        ...
                        <div><strong>Payment Method</strong></div><br>
                            ...
                            <div class="caption">
                                ...
                                <div class='form-row row'>
                                    <div class='col-xs-12 col-md-4 form-group cvc required'>
                                        ...
                                        <input autocomplete='off' name="cvv" class='input card-cvc' placeholder='e.g 415' size='4'
                                               type='text'>
                                    </div>
                                    <div class='col-xs-12 col-md-4 form-group expiration required'>
                                        <label class='control-label'>Expiration Month</label> <input
                                            class='input card-expiry-month' name="exp_m" placeholder='MM' size='2'
                                            type='text'>
                                    </div>
                                    <div class='col-xs-12 col-md-4 form-group expiration required'>
                                        <label class='control-label'>Expiration Year</label> <input
                                            class='input card-expiry-year' name="exp_y" placeholder='YYYY' size='4'
                                            type='text'>
                                    </div>
                                </div>
