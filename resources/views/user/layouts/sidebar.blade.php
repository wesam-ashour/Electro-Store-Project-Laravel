...
{{--                    <img alt="user-img" class="avatar avatar-xl brround" src="{{asset('storage/'.$photo->path)}}"><span class="avatar-status profile-status bg-green"></span>--}}
{{--                    @endforeach--}}
                </div>
                <div class="user-info">
                    <h4 class="font-weight-semibold mt-3 mb-0">{{$user->first_name . ' ' . $user->last_name}}</h4>
                    <span class="mb-0 text-muted">Role: User</span>
                </div>
            </div>
        </div>
        <ul class="side-menu">
            ...
            <li class="slide">
                <a class="side-menu__item" href="{{url('/user/products')}}">
                    <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                        <path d="M0 0h24v24H0V0z" fill="none"/>
                        <path
