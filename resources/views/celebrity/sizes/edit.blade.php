        ...
        <div class="col-lg-7 col-xl-7 col-md-12 col-sm-12">
            <div class="card  box-shadow-0 ">
                <div class="card-header">
                    <h4 class="card-title mb-1">Edit size details</h4>
                </div>
                            ...
                            <div class="row row-sm">
                                <div class="col-lg-6">
                                    ...
                                    <input type="text" name="name_en" class="form-control"
                                        placeholder="Enter Size name english" value="{{$size->getTranslation('name','en')}}">
                                </div>

                                <div class="col-lg-6">
                                    <label>Size Name (AR)</label>
                                    <input type="text" name="name_ar" class="form-control"
                                        placeholder="Enter Size name arabic" value="{{$size->getTranslation('name','ar')}}">
                                </div>
