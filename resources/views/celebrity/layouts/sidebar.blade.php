...
<aside class="app-sidebar sidebar-scroll">
    <div class="main-sidebar-header active" style="background-color:RGB(216, 222, 233)">
        <a class="desktop-logo logo-light active" href="{{url('/')}}"><img src="{{asset('assets/home/img/logo.png')}}"
                                                                         class="main-logo" alt="logo"></a>
        <a class="desktop-logo logo-dark active" href="{{url('/')}}"><img src="{{asset('assets/home/img/logo.png')}}"
...
{{--                    <img alt="user-img" class="avatar avatar-xl brround" src="{{asset('storage/'.$user->image)}}"><span class="avatar-status profile-status bg-green"></span>--}}

                </div>
                <div class="user-info">
                    <h4 class="font-weight-semibold mt-3 mb-0">{{$user->first_name . ' ' . $user->last_name}}</h4>
                    <span class="mb-0 text-muted">Role: celebrity user</span>
                </div>
            </div>
        </div>
        <ul class="side-menu">
            ...
            <li class="slide">
                <a class="side-menu__item" href="{{route('celebrity.dashboard')}}">
            ...
            <li class="slide">
                <a class="side-menu__item" href="{{route('get_all_orders')}}">
                    <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                        <path d="M0 0h24v24H0V0z" fill="none"/>
                        <path
                            d="M12 4c-4.42 0-8 3.58-8 8s3.58 8 8 8 8-3.58 8-8-3.58-8-8-8zm3.5 4c.83 0 1.5.67 1.5 1.5s-.67 1.5-1.5 1.5-1.5-.67-1.5-1.5.67-1.5 1.5-1.5zm-7 0c.83 0 1.5.67 1.5 1.5S9.33 11 8.5 11 7 10.33 7 9.5 7.67 8 8.5 8zm3.5 9.5c-2.33 0-4.32-1.45-5.12-3.5h1.67c.7 1.19 1.97 2 3.45 2s2.76-.81 3.45-2h1.67c-.8 2.05-2.79 3.5-5.12 3.5z"
