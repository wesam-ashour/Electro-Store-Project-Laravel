                        ...
                        <div class="">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-control"
                                       placeholder="Enter name" value="{{$ads->name}}">
                            </div>
                            <div class="form-group">
                                <label>Status</label>
                                <select class="form-control" name="status" required>
                                    @foreach( App\Models\User::STATUS as $status )
                                        <option
                                            value="{{ $status }}" {{ (old('status') ? old('status') : $ads->status ?? '') == $status ? 'selected' : '' }}>{{ ucfirst($status) }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" name="priority" class="form-control"
                                       placeholder="Enter priority" value="{{$ads->priority}}">
                            </div>
                            <div class="form-group">
                                <label>Image</label>
