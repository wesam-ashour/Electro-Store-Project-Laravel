...
@section('content')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Celebrities Sections</h4><span class="text-muted mt-1 tx-13 ml-2 mb-0">/
                ...
                <div class="card-header pb-0">
                    ...
                    <div class="row row-xs wd-xl-80p">
                        <div class="pull-right">
                            <a class="btn btn-primary-gradient btn-block" href="{{ route('celebrities.create') }}"> Create New
                                Celebrity</a>
                        </div>
                    </div>
                </div>
                            ...
                            <tbody>
                                @foreach ($celebrities as $key => $celebrity)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('celebrities.edit', $celebrity->id) }}" class="btn btn-sm btn-info">
