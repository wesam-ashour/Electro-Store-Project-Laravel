                        ...
                        <table class="table table-bordered table-hover mb-0 text-nowrap">
                            ...
                            <tr>
                                <td>
                                    <div class="media">
                                        <div class="card-aside-img">
                                            <img src="{{asset('storage/'.$product['cover'])}}" alt="img" class="h-60 w-60">
                                        </div>
                                ...
                                <td class="text-center">
                                    <a class="form-control" href="#" ><i class="fa fa-edit"></i></a>
                                    <a class="form-control" href="#" ><i class="fa fa-trash"></i></a>
                                </td>
                            </tr>
                            @endforeach
                            </tbody>
