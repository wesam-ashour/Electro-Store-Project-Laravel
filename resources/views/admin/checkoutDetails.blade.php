                        ...
                        @if(session('cart'))
                            ...
                            <div class="product-details table-responsive text-nowrap">
                                <table class="table table-bordered table-hover mb-0 text-nowrap">
                                    ...
                                    <th class="w-150">Size</th>
                                    <th class="w-150">Color</th>
                                    <th class="w-150">Quantity</th>

                                    <th>Price</th>
                                    <th><a class="btn btn-sm btn-outline-danger" href="{{route('clearCart')}}">Clear
                                            Items</a></th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    ...
                                    <tr data-id="{{ $id }}">
                                        @foreach($cart['color_items'] as $index => $c)
                                                ...
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <div class="card-item-desc mt-0">
                                                            <dt>Product Name:</dt>
                                                            <h6 class="font-weight-semibold mt-0 text-uppercase">{{ \App\Models\Product::find($cart['id'])->title}}
                                                            </h6>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <td>
                                                {{\App\Models\Size::find($c['size'])->name }}
                                            </td>
                                            <td>
                                                {{\App\Models\Color::find($c['color'])->name }}
                                            </td>
                                            <td>
                                            ...
                                            <td class="text-center text-lg text-medium">
                                                ${{ \App\Models\Product::find($cart['id'])->price }}</td>
                                            <td class="text-center"><a class="remove-from-cart" href="#"
                                                                       data-toggle="tooltip" title=""
                                                                       data-original-title="Remove item"><i
                                                        class="fa fa-trash"></i></a></td>
                                    </tr>
                                    @php $total += \App\Models\Product::find($cart['id'])->price * $c['quantity'] @endphp
                                    @endforeach
                                    @endforeach
                                    @endif
                                    </tbody>
                            ...
                            <div class="shopping-cart-footer  border-top-0">
                                ...
                                <div data-th="Subtotal" class="column text-lg">Subtotal: <span
                                        class="tx-20 font-weight-bold ml-2"> ${{ $total }}</span></div>

                            </div>
                            <div class="shopping-cart-footer">
                                <div class="column"><a class="btn btn-secondary" href="{{route('products.index')}}">Back
                                        to Shopping</a></div>
                                <div class="column"><a class="btn btn-primary" href="{{route('cart')}}" data-toast=""
